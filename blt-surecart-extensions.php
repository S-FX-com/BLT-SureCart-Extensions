 ...
 * Description:       Umbrella extension plugin adding modular capabilities to SureCart. Ships with a Shippo Fulfillment module: purchases shipping labels after payment and keeps tracking status in sync.
 * Version:           0.1.0
